    ...
    <div className="relative my-10 w-full overflow-hidden rounded-lg">
      <div className="relative h-[600px] w-full md:h-[500px] lg:h-[600px]">
        <picture className="absolute inset-0 h-full w-full">
          <source
            srcSet="./images/home/mobile/image-hero-coffeepress.jpg"
            media="(max-width: 768px)"
          />
          <source
            srcSet="./images/home/tablet/image-hero-coffeepress.jpg"
            media="(min-width: 769px)"
          />
          <source
            srcSet="./images/home/desktop/image-hero-coffeepress.jpg"
